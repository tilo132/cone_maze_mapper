...
//    RCLCPP_INFO(nh_->get_logger(), std::to_string(velocity[1]).c_str());

  if (abs(velocity[0]) > 1000 || abs(velocity[1]) > 1000 ||
      abs(position[0] - last_position[0]) > 1000 || abs(position[1] - last_position[1]) > 1000) {
