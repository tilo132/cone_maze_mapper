...
#include "cat_node/turtlebot3.hpp"
...
: Node("cat_node", rclcpp::NodeOptions().use_intra_process_comms(true))
{
...
void TurtleBot3::add_wheels()
{
  ...
  this->get_parameter_or<float>("wheels.separation", wheels_.separation, 0.280);
